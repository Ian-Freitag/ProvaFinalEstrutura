...
//	}
	...
	public No buscar(String placa) {
	    ...
	    No atual = raiz;  
	    while (!atual.getChave().equals(placa)) { 
	      if(atual.getChave().compareTo(placa) > 0 ) atual.setEsquerda(atual.getEsquerda());  
	      else atual = atual.setDireita(atual.getDireita()); 
